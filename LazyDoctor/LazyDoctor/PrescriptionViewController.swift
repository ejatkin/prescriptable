...
class PrescriptionViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func getAllAntibiotics() -> [Antibiotic] {
        ...
        let gentamicin = Antibiotic(name: "Gentamicin", system: "Central Nervous System", typeOfInfection: "Bacterial Meningitis (pathogen identified)", dosagePerKG: "Refer to microbiology", isForPregnant: "Pregnant", penicillinAllergenic: "Allergic to Penicillin", antibioticDescription: "Discuss course length of Gentamicin with a Consultant Microbiologist")
